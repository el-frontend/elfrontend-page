...
export const COPY: Record<Lang, CopyByLang> = {
  en: {
    ...
    nowList: {
      easy: [
        "Creating Resuelve — the #1 service platform in Cuba",
        "Writing about AI and web topics on LinkedIn",
        "Building Synclat — the first Latin Music sync platform",
        "Collaborating with other developers and mentoring some of them",
        "Open for consulting",
      ],
      medium: [
        "Building Resuelve, #1 service platform in Cuba",
        "Writing about AI & web on LinkedIn",
        "Building Synclat, Latin Music sync platform",
        "Mentoring devs, collaborating with peers",
        "Open for consulting",
      ],
      hard: ["RESUELVE", "LINKEDIN AI/WEB", "SYNCLAT", "MENTORING", "CONSULT OPEN"],
    },
  ...
  es: {
    ...
    nowList: {
      easy: [
        "Creando Resuelve — la plataforma de servicios #1 en Cuba",
        "Escribiendo sobre IA y web en LinkedIn",
        "Construyendo Synclat — la primera plataforma de sync de música latina",
        "Colaborando con otros developers y mentorizando a algunos",
        "Abierto a consultoría",
      ],
      medium: [
        "Construyendo Resuelve, plataforma de servicios #1 en Cuba",
        "Escribiendo sobre IA y web en LinkedIn",
        "Construyendo Synclat, plataforma de sync de música latina",
        "Mentorizando devs y colaborando",
        "Abierto a consultoría",
      ],
      hard: ["RESUELVE", "LINKEDIN IA/WEB", "SYNCLAT", "MENTORING", "CONSULT ABIERTO"],
    },
